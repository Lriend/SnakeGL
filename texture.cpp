...
Texture::Texture(const char* fileName, GLenum type)
{
	...
	else std::cout << "ERROR! TEXTURE.CPP/CTOR : TEXTURE_LOADING_FAILED: " << fileName << std::endl;
...
void Texture::loadFromFile(const char* fileName) {
	...
	else std::cout << "ERROR! TEXTURE.CPP/LOADFROMFILE : TEXTURE_LOADING_FAILED: " << fileName << std::endl;
